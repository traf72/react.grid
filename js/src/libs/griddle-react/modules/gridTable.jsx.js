    ...
    if (!this.props.externalIsLoading || this.props.enableInfiniteScroll) {
      ...
      var nodes = nodeData.map(function (row, index) {
        ...
        return React.createElement(GridRowContainer, {
          ...
          isRowSelected: that.props.isRowSelected,
          onRowSelected: that.props.onRowSelected,
          isSelectable: that.props.isSelectable,
        });
      });
      ...
      if (this.props.showNoData) {
        ...
        nodes.push(React.createElement('tr', { key: 'no-data-section' }, React.createElement('td', { colSpan: colSpan, className: "no-data-col" }, this.props.noDataSection)));
      }
