...
var Griddle = createReactClass({
    ...
    getDefaultProps: function getDefaultProps() {
        return {
            ...
            "noDataClassName": "no-data-container",
    ...
    componentWillMount: function componentWillMount() {
        ...
        this.columnSettings = new ColumnProperties(this.props.results.length > 0 ? deep.keys(this.props.results[0]) : this.props.columnMetadata.map(function(column) { return column.columnName }), this.props.columns, this.props.childrenColumnName, this.props.columnMetadata, this.props.metadataColumns);
    ...
    getFilter: function getFilter() {
		return this.props.showFilter && this.shouldUseCustomGridComponent() === false
			...
			? React.createElement(CustomFilterContainer, {
				...
				extraProps: this.props.customFilterComponentProps,
    ...
    getNoDataSection: function getNoDataSection() {
        ...
        return React.createElement(GridNoData, { noDataMessage: this.props.noDataMessage, noDataClassName: this.props.noDataClassName });
    },
